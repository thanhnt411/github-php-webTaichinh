            ...
            <div class="header__contact">
              <div class="header__contact--left">
                ...
                <div class="header__contact-text">
                  ...
                  <a
                    ...
                    href="mailto:thanhtien412006@gmail.com">contact@sabfa.com.vn</a>
                </div>
              </div>
              ...
              <div class="header__contact--right">
                ...
                <div class="header__contact-text">
                  ...
                  <a class="header__contact-link" href="tel:0868679028">0963561906</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="header__menu-wrapper">
        <div class="header__menu container">
          ...
          <div class="header__menu-traslate">
            ...
            <a href=""><img src="./assets/img/Mask Group (1).png" alt="" /></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="footer">
          ...
          <div class="footer__background">
            ...
            <div class="footer__company-contact">
              ...
              <div class="company-contact__box">
                ...
                <a href="tel:0868679028" class="company-contact__tel">Số điện thoại: 0963561906</a>
                <a
                  href="mailto:thanhtien4112006@gmail.com"
                  class="company-contact__email">Email: contact@sabfa.com.vn</a>
              </div>
            </div>
              ...
              <ul class="company-link__item">
                <li>
                  <img
                    class="company-support__icon"
                    src="./assets/img/Polygon 4.png"
                    alt="" /><a href="">Giới thiệu</a>
                </li>
                <li>
                  <img
                    class="company-support__icon"
                    src="./assets/img/Polygon 4.png"
                    alt="" /><a href="">Dịch vụ</a>
                </li>
                <li>
                  <img
                    class="company-support__icon"
                    src="./assets/img/Polygon 4.png"
                    alt="" /><a href="">Đào tạo</a>
                </li>
                <li>
                  <img
                    class="company-support__icon"
                    src="./assets/img/Polygon 4.png"
                    alt="" /><a href="">Sản phẩm</a>
                </li>
                <li>
                  <img
                    class="company-support__icon"
                    src="./assets/img/Polygon 4.png"
                    alt="" /><a href="">Tin tức</a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="chat">
        <div class="chat__box-1">
          <a href="tel:0868679028"><i class="fa-solid fa-phone-volume chat__icon phone"></i></a>
        </div>
        <div class="chat__box-2">
          <a href=""><i class="fa-brands fa-facebook-messenger chat__icon mess"></i></a>
        </div>
